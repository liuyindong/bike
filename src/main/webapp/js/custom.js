...
Modernizr.load({
	...
	yep :['http://test.res.rdec.com.cn/test/css/touch.css?v=1'],
	nope: ['http://test.res.rdec.com.cn/test/external/waypoint/waypoints.min.js'],
	complete : function ()
	{
		if (Modernizr.touch){
			//initMobile
