...
public class Fech
{
    ...
    public CallRet fetch(String from, String bucket, String key) throws InvalidKeyException, NoSuchAlgorithmException, IOException {
        ...
        String accessToken = signRequest(post, "-2CTAAayGA4r8nlXRtablZzJxfiN5cZcowkETDGc", "dxMvOZQg_vryrBm1aFVZlP5po1R-HdZmx4jG7gei");
